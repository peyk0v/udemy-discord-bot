...
function createStartText(channelsAsString) {
  const header = '**:wave: hi, welcome! **' 
    ...
    + '\n\n'
    + 'The only thing you have to do is select which channel will be the target for the bot to publish the found courses'
    + '\n\n'
    + 'So before starting make sure to ***set a channel***, otherwise you wont receive any course because the bot will not have a target channel'
    + '\n\n'
